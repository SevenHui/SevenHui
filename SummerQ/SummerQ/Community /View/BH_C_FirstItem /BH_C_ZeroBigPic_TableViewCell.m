//
//  BH_C_ZeroBigPic_TableViewCell.m
//  SummerQ
//
...
@implementation BH_C_ZeroBigPic_TableViewCell
-(void)dealloc{
...
//    self.labelAuthor.backgroundColor = COLOR;
    // 标题
    self.labelTitle.frame = CGRectMake(WIDTHBACK * 0.15, 20 * lfheight + HEIGHTBACK * 0.1, WIDTHBACK - (WIDTHBACK * 0.15), HEIGHTBACK * 0.3);
